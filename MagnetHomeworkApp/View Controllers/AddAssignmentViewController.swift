...
class AddAssignmentViewController: UIViewController {
    ...
    private var addAssignmentView: AddAssignmentView?
 ...
 */
        initializeAddAssignmentView {
        
            self.view.addSubviews([self.addAssignmentView!, self.addAssignmentButton])
            self.addAssignmentViewConstraints()
